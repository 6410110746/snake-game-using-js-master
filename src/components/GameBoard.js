  ...
  render() {
    return (
      ...
      <AppBar position="static" style={{ background: '#2C1E55' }}>
        <Toolbar>
          <Typography variant="h4" component="div" sx={{ flexGrow: 1, fontFamily: 'monospace', fontWeight: 700}} style={{textDecoration:"none"}}>
            Snake Game
          </Typography>
        </Toolbar>
      </AppBar>
        ...
        <div className='score-area'>
          ...
          <div className='container'>
            <div className='btn-container'>
              <Link to='/snakemain' style={{textDecoration:"none"}}>
                <button className='resetbtn'>Home</button>
              </Link>
              <button className='resetbtn' onClick={this.pauseGame}>Pause</button>
            </div>
          </div>
        </div>
      </div>
